...
function loadStore() {
  ...
  try {
    ...
    console.log('[evidence-gate] ledger restored from store: ' + keys.length + ' session(s)')
  } catch (e) {
...
module.exports = {
  ...
  apply(ctx) {
    ...
    console.log('[evidence-gate] tools/result listener attached (arguments + output anchors)')
    ...
    if (systemPrompt !== undefined) {
      ...
      console.log('[evidence-gate] per-session policy section registered')
    } else {
    ...
    if (commands !== undefined) {
      ...
      console.log('[evidence-gate] /evidence-gate command registered')
    } else {
    ...
    console.log('[evidence-gate] evidence_gate_switch registered (per-session, default OFF)')
    ...
    if (tools !== undefined) {
      ...
      console.log('[evidence-gate] evidence_gate tool registered (per-session gate check inside)')
    } else {
    ...
    if (webServer !== undefined) {
      ...
      console.log('[evidence-gate] /api/dsh-evidence-gate route registered (session-scoped)')
    } else {
